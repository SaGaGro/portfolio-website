    ...
    <div className="mx-auto max-w-[1440px] px-5 py-20 sm:px-8 lg:px-12 lg:py-28">
      ...
      <div className="mt-16 grid gap-6 lg:grid-cols-[1fr_0.55fr]">
        <div className="rounded-[2rem] bg-[#d9ff62] p-8 sm:p-12">
          <p className="max-w-xl text-xl leading-8 text-black/65">Have an idea, a collaboration, or a problem worth untangling? GitHub is the first open channel while the direct contact details are being prepared.</p>
          <a href="https://github.com/SaGaGro" target="_blank" rel="noreferrer" className="group mt-12 inline-flex items-center gap-3 rounded-full bg-[#171b18] px-6 py-4 text-sm font-bold text-white">Open GitHub profile <ArrowIcon className="size-4 transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" /></a>
        </div>
